...
values
("publicação do usuario 1", "essa é a publicacação do usuario 1", 1),
("publicação do usuario 2", "essa é a publicacação do usuario 2", 2),
("publicação do usuario 3", "essa é a publicacação do usuario 3", 3);